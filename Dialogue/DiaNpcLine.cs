...
public class DiaNpcLine : DiaMaster
{
    ...
    [SerializeField] private Transform Dest = null; //Leave blank if ending dia
    ...
    public Transform return_dest()
    {
        ...
        if(FlagForAlternateDest && ZF.CheckFlag(FlagForAlternateDest.name))
        {
